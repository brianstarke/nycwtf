...
module.exports.parseDescription = function (text) {
    text = text.substr(this.findPossibleEndOfAddress(text), text.length).trim();
    return this.cleanupText(text);
}

module.exports.parseTextForAddress = function (text) {
...
var cleanupText = module.exports.cleanupText = function (text) {
    ...
    if (newText.indexOf('.', 0)) {
        newText = newText.substr(1, newText.length).trim();
    }
